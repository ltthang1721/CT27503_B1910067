    ...
    ?>
        <tr style="height: 40px">
            ...
            <td style="text-align:center; ">
                <a style="color:#337ab7 !important" href="modu/quanlydanhmucsp/xuly.php?iddanhmuc=<?php echo $row['id_danhmuc'] ?>"><span class="material-icons-outlined" >delete </span></a> | <a style="color:#337ab7 !important" href="?action=quanlydanhmucsanpham&query=sua&iddanhmuc=<?php echo $row['id_danhmuc']?>"><span class="material-icons-outlined" >edit </span></a> 
            </td>
        </tr>
    <?php
    }
