    ...
    ?>
        <form method="POST" action="modu/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>" enctype="multipart/form-data">
            <tr>
                ...
                <td><input style="border: 1px #337ab7 solid ; height: 40px; width:800px" type="text" value="<?php echo $row['tenbaiviet'] ?> " name="tenbaiviet"></td>
            </tr>
            <tr>
                ...
                <td style="margin-top: 20px">
                    ...
                    <select name="danhmuc" style="height: 35px; border:#337ab7 solid 1px;margin-left: 40px;">
                        <?php
