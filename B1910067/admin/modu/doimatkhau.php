...
<div style=" width: 500px; color:#337ab7; font-family:Muli ; margin-top:20%">
    ...
    <table border="0" width="100%" style=" border-collapse: collapse; height: 320px;  border:none; background:#F0F0F0 ">
        <form method="POST" action="">
            <tr>
                ...
                <td>
                    <input style="border: 1px #337ab7 solid ; height: 40px; width:230px" type="password" class="form-control" name="password_cu" placeholder="Mật khẩu cũ" />
                </td>
            </tr>
            <tr>
                <td style="padding-left:30px; font-size: 18px; font-weight:bold">Mật khẩu mới</td>
                <td>
                    <input style="border: 1px #337ab7 solid ; height: 40px; width:230px" type="password" class="form-control" id="password" name="password_moi" placeholder="Mật khẩu mới" />
                </td>
            </tr>
