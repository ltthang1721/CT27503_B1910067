...
?>
<div style=" width: 1080px; color:#337ab7 !important; margin-bottom: 50px; font-family: muli;">
    ...
    <table border="1" style="width:100%" style="border-collapse:collapse; ">
        <tr style="height: 60px; background: #337ab7; color: white ; font-size: 16px">
            <th style="text-align:center; width: 40px">ID</th>
            <th style="text-align:center; width: 70px">Mã Đơn</th>
            ...
            <tr style="border-bottom:1px #337ab7 solid; color:black">
                ...
                <td style="text-align:center;font-weight:bold ">
                    ...
                    if ($row['cart_status'] == 1) {
                        echo '<a style="color:#337ab7 !important" href="modu/quanlydonhang/xuly.php?cart_status=0&code=' . $row['code_cart'] . '"> <span style="font-size:14px ;" class="material-icons-outlined" >square</span> Xác Nhận</a>';
                        $dem++;
                    } else {
                ...
                <td style="text-align:center;">
                    <a style="color:#337ab7 !important; font-weight:bold" href="index.php?action=donhang&query=xemdonhang&code=<?php echo $row['code_cart'] ?>"><span style="font-size:14px ;" class="material-icons-outlined">visibility </span> Xem Đơn Hàng</a>
                </td>
            </tr>
        <?php
        }
