...
?>
<div style=" width: 1300px; color:#696969!important; margin-bottom: 50px; margin-left:20px">
    <p style="font-size: 40px; text-align:center; margin-top:30px; margin-bottom:30px; ">Lịch Sử Đơn Hàng</p>
            ...
            <tr>
                ...
                <td style="text-align:center; ">
                    ...
                    if ($row['cart_status'] == 1) {
                        echo '<a style="color:#ce2a37 !important"> Chờ Xác Nhận</a>';
                        $dem++;
                    } else {
                        echo '<a style="color:#23468c!important"> Đã Xác Nhận</a>';
                    }
                    ?>
                </td>
                <td style="text-align:center"><?php echo $row['cart_date'] ?></td>
                <td style="text-align:center;">
                    <a style="color:#ce2a37 !important" href="home.php?quanly=xemdonhang&code=<?php echo $row['code_cart'] ?>"><span style="font-size:14px ;" class="material-icons-outlined">visibility </span> Xem Đơn Hàng</a>
                </td>
            </tr>
        <?php
        }
