...
if ($num > 0) {
?>
    <div style=" width: 1000px; color:#337ab7 !important; margin-bottom: 50px">
        ...
        <form action="index.php?action=quanlytimkiem&query=timkiembv" method="POST">
            <div class="input-group" style="float:right ; margin-bottom:20px; margin-top: -40px">
                <input type="text" style="border:#337ab7 solid 1px; color:#337ab7; margin-left: -60px" class="form-control input-search" name="tukhoa" placeholder="Tìm kiếm..." aria-label="Search" aria-describedby="basic-addon2">
                <input type="submit" style="border:#337ab7 solid 1px; color:#337ab7; height:34px" value="Search" placeholder="Tìm kiếm" name="timkiembv">
            </div>
        </form>
        <table style="width:100%" border="1" style="border-collapse:collapse;">
            <tr style="height: 60px; background: #337ab7; color: white ; font-size: 17px">
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align:center">
                        <a style="color:#337ab7 !important" href="modu/quanlybaiviet/xuly.php?idbaiviet=<?php echo $row['id'] ?>"><span class="material-icons-outlined">delete </span></a> | <a style="color:#337ab7 !important" href="?action=quanlybaiviet&query=sua&idbaiviet=<?php echo $row['id'] ?>"><span class="material-icons-outlined">edit </span></a>
                    </td>
                </tr>
            <?php
            }
...
?>
    <h1 style="text-align:center; color:#337ab7!important; margin-top:200px" class="mt-5"> Từ Khóa Tìm Kiếm: "<?php echo $_POST['tukhoa'] ?>"</h1>
    <a style="text-align: center; color:#337ab7!important; font-size: 18px"> Không có kết quả phù hợp. Vui lòng tìm lại! </a>
    <form action="index.php?action=quanlytimkiem&query=timkiembv" method="POST">
        <div class="input-group" style=" margin-top:20px;margin-left:100px ">
            <input type="text" style="border:#337ab7 solid 1px; color:#337ab7; margin-left: -60px" class="form-control input-search" name="tukhoa" placeholder="Tìm kiếm tin tức..." aria-label="Search" aria-describedby="basic-addon2">
            <input type="submit" style="border:#337ab7 solid 1px; color:#337ab7; height:34px" value="Search" placeholder="Tìm kiếm" name="timkiembv">
        </div>
    </form>
<?php
