...
<div style=" width: 1000px; color:#337ab7 !important; margin-bottom: 50px">
    ...
    <form action="index.php?action=quanlytimkiem&query=timkiemsp" method="POST">
        <div class="input-group" style="float:right ; margin-top:10px ">
            ...
            <input type="submit" style="border:#337ab7 solid 1px; color:white; height:34px; background:#337ab7" value="Search" placeholder="Tìm kiếm" name="timkiem">
        </div>
    </form>
        ...
        ?>
            <tr style="border-bottom:1px #337ab7 solid">
                ...
                <td style="text-align:center;">
                    <a style="color:#337ab7 !important" href="modu/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>"><span class="material-icons-outlined">delete </span> </a> | <a style="color:#337ab7 !important" href="?action=quanlysanpham&query=sua&idsanpham=<?php echo $row['id_sanpham'] ?>"><span class="material-icons-outlined">edit </span></a>
                </td>
            </tr>
        <?php
        }
    ...
    <ul class="list_trang" >
        ...
        ?>
            <li <?php if ($i == $page) {
                    echo 'style="background: #337ab7; font-weight:bold;"';
                } else {
                    '';
