                    ...
                    <div class="col-3 mb-5">
                        <div id="bt_imageeffect">
                            ...
                            <li class="galleryItem">
                                <a class="caption" data-description="Xem thêm..." href="bohoa.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>">
...
?>
    <h1 style="text-align:center; font-family:Muli"> Từ Khóa Tìm Kiếm: <?php echo $_POST['tukhoa'] ?></h1>;
    <a style="text-align: center" class="mb-4"> Không có kết quả phù hợp. Vui lòng tìm lại! </a>;
    <img style="width: 300px ; margin-left:40%" src="ig/a1.jpg">
<?php
}
?>