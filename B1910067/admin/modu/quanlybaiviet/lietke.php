...
<div style=" width: 1000px; color:#337ab7 !important; margin-bottom: 50px">
    ...
    <form action="index.php?action=quanlytimkiem&query=timkiembv" method="POST">
        <div class="input-group" style="float:right ;margin-top:10px">
            ...
            <input type="submit" style="border:#337ab7 solid 1px; color:white; height:34px; background:#337ab7" value="Search" placeholder="Tìm kiếm" name="timkiembv">
        </div>
    </form>
    <table style="width:100%" style="border-collapse:collapse;">
        ...
        while ($row = mysqli_fetch_array($query_lietke_bv)) {
            $i++;
        ?>
            <tr style="border-bottom:1px #337ab7 solid; color:black">
