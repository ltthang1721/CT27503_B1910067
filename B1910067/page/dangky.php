                    ...
                    <div class="card-body" style="margin-left: 100px ; ">
                        <form id="signupForm" method="post" class="form-horizontal" action="#">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="firstname" name="hovaten" placeholder="Họ & Tên của bạn" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="email" name="dienthoai" placeholder="Số điện thoại của bạn" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="firstname">Địa Chỉ</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="firstname" name="diachi" placeholder="Địa chỉ của bạn" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="row">
                                <div class="col-sm-7 offset-sm-4">
                                    <button type="submit" class="btn btn-primary" name="dangky" value="Sign up" style="background:#ce2a37 ; border: #ce2a37;">Đăng ký</button>
