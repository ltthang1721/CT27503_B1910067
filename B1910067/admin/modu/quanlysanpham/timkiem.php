    ...
    <div style=" width: 1000px; color:#337ab7 !important; margin-bottom: 50px">
        ...
        <form action="index.php?action=quanlytimkiem&query=timkiemsp" method="POST">
            <div class="input-group" style="float:right ; margin-bottom:20px; margin-top: -40px">
                ...
                <input type="submit" style="border:#337ab7 solid 1px; color:#337ab7; height:34px" value="Search" placeholder="Tìm kiếm" name="timkiem">
            </div>
        </form>
        ...
        <table style="border-collapse:collapse;width:100%">
            ...
            while ($row = mysqli_fetch_array($query_pro)) {
                $i++;
            ?>
                <tr style="border-bottom:1px #337ab7 solid">
                    ...
                    <td style="text-align:center;">
                        <a style="color:#337ab7 !important" href="quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>"><span class="material-icons-outlined">delete </span> </a> | <a style="color:#337ab7 !important" href="?action=quanlysanpham&query=sua&idsanpham=<?php echo $row['id_sanpham'] ?>"><span class="material-icons-outlined">edit </span></a>
                    </td>
                </tr>
            <?php
            }
...
?>
    <h1 style="text-align:center; color:#337ab7!important; margin-top:200px" class="mb-5"> Từ Khóa Tìm Kiếm: <?php echo $_POST['tukhoa'] ?></h1>
