...
?>
<div style=" width: 1000px; color:#337ab7 !important; margin-bottom: 50px; font-family: muli;"> 
...
<table style="width:100%" border="1" style="border-collapse:collapse;">
    ...
    ?>
        <tr style="border-bottom:1px #337ab7 solid; color:black">
            ...
            <a style="color:#337ab7 !important" href="modu/quanlyusers/xuly.php?idkhachhang=<?php echo $row['id_dangky'] ?>"><span class="material-icons-outlined" >delete </span> </a> 
            </td>
        </tr>
    <?php
    }
