    ...
    <table border="0" width="100%" style=" border-collapse: collapse; border:none; ">
        <form method="POST" action="modu/quanlysanpham/xuly.php" enctype="multipart/form-data">
            <tr>
                ...
                <td>
                    <input type="text" style="border: 1px #337ab7 solid ; height: 30px; width:250px" name="tensanpham">
                    <span style="padding-left:100px ; font-size: 16px; font-weight:bold;"> Mã Sản Phẩm </span>
                    <input style="border: 1px #337ab7 solid ; height: 30px; width:250px; float:right" type="text" name="masp">
                </td>
            </tr>
            <tr>
                <td style=" font-size: 16px; font-weight:bold; width: 150px; height: 60px; ">Giá Sản Phẩm</td>
                <td>
                    <input style="border: 1px #337ab7 solid ; height: 30px; width:250px" type="text" name="giasp">
                    <span style="padding-left:100px ; font-size: 16px; font-weight:bold;">Số Lượng</span>
                    <input style="border: 1px #337ab7 solid ; height: 30px; width:250px; float:right " type="text" name="soluong">
                </td>
            ...
            <tr>
                ...
                <td>
                    <select name="danhmuc" style="height: 35px; border:#337ab7 solid 1px;">
                        <?php
