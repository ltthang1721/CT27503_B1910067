...
if ($cart_query) {
    ...
    $tieude = "ĐƠN HÀNG ĐÃ ĐẶT THÀNH CÔNG TRÊN WEBSITE 7LAROSE.COM!!!";
    $noidung = "<h3  style='color: #337ab7'> Cảm ơn quý khách đã đặt hàng với mã đơn hàng là: " . $code_order . "</h3>";
    $noidung .= "<h3 style='color: #337ab7'>Đơn hàng của quý khách bao gồm: </h3>";

   $noidung.=" <table style='background:#b6deff33;' > 
        <tr> 
