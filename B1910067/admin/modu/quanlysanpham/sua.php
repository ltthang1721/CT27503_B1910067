        ...
        ?>
            <form method="POST" action="modu/quanlysanpham/xuly.php?idsanpham=<?php echo $row['id_sanpham'] ?>" enctype="multipart/form-data">
                <tr>
                    ...
                    <td><input style="border: 1px #337ab7 solid ; height: 30px; width:250px" type="text" value="<?php echo $row['tensanpham'] ?> " name="tensanpham">
                        <span style="padding-left:100px ; font-size: 16px; font-weight:bold;"> Mã Sản Phẩm </span>
                        <input style="border: 1px #337ab7 solid ; height: 30px; width:250px;float:right" type="text" value="<?php echo $row['masp'] ?> " name="masp">
                    </td>
                </tr>
                <tr>
                    <td style=" font-size: 16px; font-weight:bold; width: 150px; height: 60px; ">Giá Sản Phẩm</td>
                    <td><input style="border: 1px #337ab7 solid ; height: 30px; width:250px" type="text" value="<?php echo $row['giasp'] ?> " name="giasp">
                        <span style="padding-left:100px ; font-size: 16px; font-weight:bold;">Số Lượng</span>
                        <input style="border: 1px #337ab7 solid ; height: 30px; width:250px;float:right" type="text" value="<?php echo $row['soluong'] ?> " name="soluong">
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <select name="danhmuc" style="height: 35px; border:#337ab7 solid 1px;margin-left: 60px;">
                            <?php
