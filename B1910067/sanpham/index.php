    ...
    <div style="background-color: rgb(255, 255, 255);">
        ...
        <div class="container ">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="product-grid2">
                            <div class="product-image2 zoomin content ">
                                <a href="bohoa.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>">
                                ...
                                <ul class="social">
                                    <li><a style="margin-bottom:40px; " href="bohoa.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>" data-tip="Xem Chi Tiết"><i class="fa fa-eye" class="btn btn-info btn-lg"></i></a></li>
                            ...
                            <div class="product-content">
                                <h3 class="title1"><a href="bohoa.php?quanly=sanpham&id=<?php echo $row['id_sanpham'] ?>"><?php echo $row['tensanpham'] ?></a></h3>
            ...
            <ul class="list_trang">
                ...
                ?>
                    <li <?php if ($i == $page) {
                            echo 'style="background: #ce2a37; font-weight:bold;"';
                        } else {
                            '';
                        } ?>><a href="home.php?quanly=index&trang=<?php echo $i ?>" style="color:#ce2a37"><?php echo $i ?></a></li>
                <?php
                }
                ?>
            </ul>
