            ...
            <div class="col-md-3 col-sm-6">
                <div class="product-grid2"> 
                    <div class="product-image2 zoomin content">
                        <a href="bohoa.php?quanly=sanpham&id=<?php echo $row_pro['id_sanpham'] ?>">
                        ...
                        <form method="POST" action="bohoa.php?quanly=bohoa&id=<?php echo $row_pro['id_sanpham'] ?>">

                            <ul class="social">
                                <li><a style="margin-bottom:40px" href="bohoa.php?quanly=sanpham&id=<?php echo $row_pro['id_sanpham'] ?>" data-tip="Xem Chi Tiết"><i class="fa fa-eye" class="btn btn-info btn-lg" data-toggle="modal" data-target="#exampleModal"></i></a></li>
                                <li><a style="margin-bottom:-30px" href="#" data-tip="Thêm Giỏ Hàng" data-name="LAROSEbou001" data-price="60" class="add-to-cart"><i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                            <button name="muangay" class="add-to-cart" > Mua Ngay</button>
                        </form>
                    </div>
                    <div class="product-content">
                        <h3 class="title1"><a href="bohoa.php?quanly=sanpham&id=<?php echo $row_pro['id_sanpham'] ?>"><?php echo $row_pro['tensanpham'] ?></a></h3>
